...
class EconomicosSection extends StatefulWidget {
  EconomicosSection({Key key}) : super(key: key);
  @override
  _EconmicosSectionState createState() => _EconmicosSectionState();
}

class _EconmicosSectionState extends State<EconomicosSection> {
                                                              ...
                                                              Container(
                                                                  child: Row(
                                                                    children: <
                                                                      ...
                                                                      SizedBox(
                                                                        width: 5,),
                                                                      Text(book.nombreVendedor!=null?book.nombreVendedor.substring(0, 1).toUpperCase() +
                                                                          "." +
                                                                          book
                                                                              .apellidoVendedor:
                                                                        " ",
