...
class EditBookColegio extends StatefulWidget {
  ...
  EditBookColegio(this.book);

  @override
  _EditBookColegioState createState() => _EditBookColegioState();
}

class _EditBookColegioState extends State<EditBookColegio> {
...
//                      ),
  ...
  _siguienteBtn() {
    ...
    if (canContinue) {
      ...
      showErrorDialog(context,
          "Debes seleccionar al menos un colegio para poder continuar");
    }
  }
  ...
  Map<String, bool> createMapfromStringsList(List<String> stringsList) {
    ...
    for (String item in stringsList) {
      if(widget.book.colegios.contains(item)){
        map[item] = true;
      }else{
        map[item] = false;
      }
